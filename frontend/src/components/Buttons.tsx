export default function Buttons(props:any ):JSX.Element{
    return(
        <div className={`absolute ${props.bottom} ${props.left}`}>
            <a href="#_" className={`inline-flex items-center font-display justify-center h-16  px-10 transition delay-50 duration-250 ease-in-out -translate-y-1 hover:scale-105
